...
// The wrap-aware lng-interval blocks that lived here died with P2/P4
// (2026-07-30): the hand-written longitude arithmetic they tested is gone —
// wrap-awareness now lives in geoEnvelopeSql's two-arm union and PostGIS
// judges on the geometry itself, both proven against a real PostGIS in
// places-containment.integration.spec (THE SEAM test).
