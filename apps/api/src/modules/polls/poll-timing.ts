 ...
 * Single source of truth for the close window shared by the lifecycle cron and
 * the card's "days left" countdown. (2026-07-11 fold-in: formerly env
 * `POLL_AUTO_CLOSE_DAYS`; .env restated this value.)
 */
