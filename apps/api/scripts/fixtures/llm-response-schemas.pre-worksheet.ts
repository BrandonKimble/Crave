/** FROZEN SNAPSHOT of the collection response schema BEFORE the v24 worksheet block (commit 8b4643a4e^). Read only by scripts/backfill-prompt-schema-hash.ts to recognise rows pushed under it. Never import from src. */
