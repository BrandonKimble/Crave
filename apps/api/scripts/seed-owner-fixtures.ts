 ...
 * @runner: none — invoked by hand
 *
 * NOT a probe: this WRITES. It seeds the owner's demo account and the
 * fixtures around it — users, follows, list items, polls, comments, likes
 * and endorsements. Nothing about it answers a question and gets thrown
 * away.
 *
