...
const FLOWS: FlowEntry[] = [
  // ── English baseline ────────────────────────────────────────────────────
  {
    ...
    locale: 'en',
    query: 'taco',
    mustInclude: [{ name: 'taco', type: 'item' }],
  ...
  },
  {
    ...
    locale: 'en',
    query: 'vegan',
    mustInclude: [{ name: 'vegan', type: 'item_attribute' }],
  ...
  },
  {
    ...
    locale: 'en',
    query: 'despa',
    mustInclude: [{ name: 'despana', type: 'place' }],
  ...
  },
  {
    ...
    locale: 'es',
    query: 'vegetariano',
    mustInclude: [{ name: 'vegetarian', type: 'item_attribute' }],
  ...
  },
  {
    ...
    locale: 'es',
    query: 'picante',
    mustInclude: [{ name: 'spicy', type: 'item_attribute' }],
  ...
  // folds wrong shows up here as a miss, not as a silent near-match.
  {
    ...
    locale: 'vi',
    query: 'phở',
    mustInclude: [{ name: 'pho', type: 'item' }],
  ...
  },
  {
    ...
    mustInclude: [{ name: 'gluten free', type: 'item_attribute' }],
  ...
  // dish. zh-07/zh-08 are that law's live proof: both come back EMPTY.
  {
    ...
    locale: 'zh',
    query: '牛肉面',
    mustInclude: [{ name: 'beef noodle soup', type: 'item' }],
  ...
  },
  {
    ...
    locale: 'zh',
    query: '珍珠奶茶',
    mustInclude: [{ name: 'boba tea', type: 'item' }],
  ...
  },
  {
    ...
    locale: 'zh',
    query: '便宜',
    mustInclude: [{ name: 'affordable', type: 'place_attribute' }],
    localizedLabel: true,
