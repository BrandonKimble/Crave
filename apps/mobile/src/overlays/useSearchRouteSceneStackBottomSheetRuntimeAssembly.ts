...
export const useSearchRouteSceneStackBottomSheetRuntimeAssembly = ({
  ...
  const bodyDefaults = React.useMemo<BottomSheetSceneStackBodyDefaults>(
    () => ({
      ...
      resolvedBounces: scrollBodyDefaultsEntry.bounces,
      resolvedAlwaysBounceVertical: scrollBodyDefaultsEntry.alwaysBounceVertical,
      resolvedOverScrollMode: scrollBodyDefaultsEntry.overScrollMode,
    ...
    [
      ...
      scrollBodyDefaultsEntry.alwaysBounceVertical,
      scrollBodyDefaultsEntry.bounces,
      ...
      scrollBodyDefaultsEntry.overScrollMode,
