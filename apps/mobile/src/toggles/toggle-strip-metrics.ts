...
// Derived from the one shared control-height token (F3717, 2026-08-07: FilterChip and
// SegmentedToggle now import CONTROL_HEIGHT rather than hardcoding 32, so the band and its
// citizens genuinely read the SAME token — the earlier form of this comment asserted a
// conformance the citizens did not yet have) — never hand-listed (the type-list disease
// guard). The band enforces it physically (fixed height +
