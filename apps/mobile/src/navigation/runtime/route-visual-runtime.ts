...
export class RouteVisualRuntime {
  ...
  constructor() {
    ...
    this.routeSceneLayoutAssemblyRuntime = createRouteSceneLayoutAssemblyRuntime({
      routeHostFoundationRuntime: this.routeHostFoundationRuntime,
    });
    this.routeSheetVisualAssemblyRuntime = createRouteSheetVisualAssemblyRuntime({
      routeHostFoundationRuntime: this.routeHostFoundationRuntime,
    });
    this.routeSceneLayoutAuthority = this.routeSceneLayoutAssemblyRuntime.routeSceneLayoutAuthority;
    ...
    this.routeSheetVisualAuthority = this.routeSheetVisualAssemblyRuntime.routeSheetVisualAuthority;
    this.syncRouteHostOverlayGeometryRuntime =
      this.routeHostFoundationRuntime.routeHostSyncLane.syncRouteHostOverlayGeometryRuntime;
    this.publishRouteSharedSheetVisualBinding =
      this.routeHostFoundationRuntime.routeHostSyncLane.publishRouteSharedSheetVisualBinding;
