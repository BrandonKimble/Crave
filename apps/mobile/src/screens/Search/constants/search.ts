...
export const SEARCH_CONTAINER_PADDING_TOP = 10;
...
export const PIN_FILL_VERTICAL_BIAS = -4.8;
export const PIN_FILL_HORIZONTAL_BIAS = -0.1;
...
export const SHORTCUT_CHIP_HOLE_RADIUS = 14;
export const SEARCH_SUGGESTION_PANEL_OVERLAP = 12;
export const SEARCH_SUGGESTION_PANEL_PADDING_TOP = 0;
export const SEARCH_SUGGESTION_PANEL_PADDING_BOTTOM = SECTION_GAP;
export const SEARCH_SUGGESTION_HEADER_PADDING_BOTTOM = 12;
