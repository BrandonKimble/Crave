...
export const useSearchSuggestionLayoutPlaneRuntime = ({
  ...
  return React.useMemo(
    () => ({
      ...
      handleShortcutChipLayout: suggestionLayoutStateRuntime.handleShortcutChipLayout,
      handleSearchShortcutsScroll: suggestionLayoutStateRuntime.handleSearchShortcutsScroll,
    ...
    [
      ...
      suggestionLayoutStateRuntime.handleShortcutChipLayout,
      suggestionLayoutStateRuntime.handleSearchShortcutsScroll,
