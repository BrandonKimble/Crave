...
export const useSearchRootMapInteractionRuntime = ({
  ...
  const mapInteractionArgs = React.useMemo(
    ...
    [
      ...
      rootOverlayFoundationRuntime.rootSharedSheetRuntimeLane.cancelPendingMapMovementUpdates,
      rootOverlayFoundationRuntime.rootSharedSheetRuntimeLane.mapGestureActiveRef,
      rootOverlayFoundationRuntime.rootSharedSheetRuntimeLane.mapMotionPressureController,
      rootOverlayFoundationRuntime.rootSharedSheetRuntimeLane.markMapMovedIfNeeded,
      rootOverlayFoundationRuntime.rootSharedSheetRuntimeLane.scheduleMapIdleEnter,
      rootOverlayFoundationRuntime.rootSharedSheetRuntimeLane.schedulePollBoundsUpdate,
